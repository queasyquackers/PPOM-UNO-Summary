window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Function of Dorsal Column Medial Lemniscus (DCML)?",
      "back": "Fine Touch, Vibration, Proprioception",
      "tag": "Neuro"
    },
    {
      "front": "Function of Spinothalamic Tract (STT)?",
      "back": "Pain and Temperature",
      "tag": "Neuro"
    },
    {
      "front": "Function of Corticospinal Tract (CST)?",
      "back": "Voluntary Motor Control",
      "tag": "Neuro"
    },
    {
    ...
    {
      "front": "Where does STT decussate?",
      "back": "Spinal Cord (Anterior White Commissure)",
      "tag": "Neuro"
    },
    {
      "front": "Where does CST decussate?",
      "back": "Medulla (Pyramids)",
      "tag": "Neuro"
    },
    {
      "front": "What is spard in Anterior Spinal Artery Syndrome?",
      "back": "Dorsal Columns (Proprioception/Vibration)",
      "tag": "Pathology"
    },
    {
      "front": "Virus dormant in DRG causing Shingles?",
      "back": "Varicella Zoster Virus (VZV)",
      "tag": "Micro"
    },
    {
      "front": "Toxin blocking Renshaw Cells (GABA/Glycine)?",
      "back": "Tetanus Toxin",
      "tag": "Micro"
    },
    {
      "front": "Reflex level for Patellar (Knee) Jerk?",
      "back": "L3-L4",
      "tag": "Clinical"
    }
  ],
