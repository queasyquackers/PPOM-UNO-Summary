window.receiveLectureContent({
    ...
    "questions": [
        ...
        },
        {
            ...
            "correctAnswer": 1,
            "rationale": "This is **Wernicke's Aphasia** (Fluent, Impaired Comprehension, Impaired Repetition). The lesion is in the **Superior Temporal Gyrus** (Wernicke's Area) of the dominant hemisphere."
        },
        {
            "question": "A 25-year-old female presents with severe headache and specialized imaging reveals a thrombosis of the superior sagittal sinus. Which of the following is a key risk factor for this condition?",
            "options": [
                "Hypertension",
                "Atrial Fibrillation",
                "Tobacco Use",
            ...
            "correctAnswer": 3,
            "rationale": "**Cerebral Venous Sinus Thrombosis (CVST)** is associated with hypercoagulable states. **Oral Contraceptive Use** is a major risk factor, especially in young women. HTN/DM/Smoking are risks for *arterial* strokes."
        },
        {
            "question": "A patient is able to speak fluently and understand commands perfectly, but cannot repeat the phrase 'No ifs, ands, or buts'. They are aware of their errors and try to correct them. What is the diagnosis?",
            "options": [
                "Broca's Aphasia",
                "Wernicke's Aphasia",
                "Conduction Aphasia",
            ...
            "correctAnswer": 2,
            "rationale": "**Conduction Aphasia** is characterized by **Fluent speech** + **Intact Comprehension** + **Impaired Repetition**. It is caused by a lesion to the **Arcuate Fasciculus**."
        },
        {
            "question": "A patient presents with sudden onset of 'the worst headache of my life'. A non-contrast CT shows a 'starfish' pattern of hyperdensity in the basal cisterns. What represents the most likely etiology?",
            "options": [
