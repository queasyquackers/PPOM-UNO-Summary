window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Branches of Intradural ICA?",
      "back": "OPAM: Ophthalmic, PCom, ACA, MCA",
      "tag": "Anatomy"
    },
    {
      "front": "Which artery supplies the visual cortex?",
      "back": "Posterior Cerebral Artery (PCA)",
      "tag": "Anatomy"
    },
    {
      "front": "Clinical sign of ACA stroke?",
      "back": "Contralateral Leg Weakness",
      "tag": "Clinical"
    },
    {
      "front": "Clinical sign of MCA stroke?",
      "back": "Contralateral Face/Arm Weakness + Aphasia",
      "tag": "Clinical"
    },
    {
      "front": "Artery passing through Cavernous Sinus?",
      "back": "Internal Carotid Artery (ICA)",
      "tag": "Anatomy"
    },
    {
      "front": "Transient monocular vision loss ('Curtain')?",
      "back": "Amaurosis Fugax (Ophthalmic Artery ischemia)",
      "tag": "Clinical"
    },
    {
      "front": "Common site for Berry Aneurysm causing CN III palsy?",
      "back": "Posterior Communicating Artery (PCom)",
      "tag": "Pathology"
    },
    {
      "front": "Vessels prone to rupture in hypertension (Basal Ganglia)?",
      "back": "Lenticulostriate Arteries (Charcot-Bouchard)",
      "tag": "Pathology"
    },
    {
      "front": "What nerve passes between SCA and PCA?",
      "back": "CN III (Oculomotor)",
      "tag": "Anatomy"
    },
    {
      "front": "Risk factors for Cerebral Venous Thrombosis (CVT)?",
      "back": "Pregnancy, OCPs, Hypercoagulability",
      "tag": "Clinical"
    }
  ],
  "ankingResource": {
