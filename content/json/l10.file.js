window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Neurotransmitter of Preganglionic Sympathetic neurons?",
      "back": "Acetylcholine (ACh)",
      "tag": "Physiology"
    },
    {
      "front": "Neurotransmitter of Postganglionic Sympathetic neurons?",
      "back": "Norepinephrine (NE) - except Sweat Glands",
      "tag": "Physiology"
    },
    {
      "front": "Receptor on target organs for Parasympathetic?",
      "back": "Muscarinic (M)",
      "tag": "Physiology"
    },
    {
      "front": "Signs of Horner's Syndrome?",
      "back": "Ptosis, Miosis, Anhidrosis",
      "tag": "Clinical"
    },
    {
      "front": "Cause of Autonomic Dysreflexia?",
      "back": "SCI > T6 + Noxious Stimulus",
      "tag": "Clinical"
    },
    {
      "front": "Bladder finding in Sacral spinal cord lesion?",
      "back": "Atonic (Overflow Incontinence)",
      "tag": "Clinical"
    },
    {
      "front": "Bladder finding in Cervical spinal cord lesion?",
      "back": "Spastic (Upper Motor Neuron)",
      "tag": "Clinical"
    },
    {
      "front": "Embryologic failure in Hirschsprung's Disease?",
      "back": "Neural Crest Cell migration",
      "tag": "Pathology"
    },
    {
      "front": "Primary nerve for Parasympathetic outflow?",
      "back": "Vagus Nerve (CN X)",
      "tag": "Anatomy"
    },
    {
      "front": "Drug class for Muscarinic antagonist (e.g. Atropine)?",
