window.receiveLectureContent({
    ...
    "questions": [
        {
            ...
            "correctAnswer": 2,
            "rationale": "**Etomidate** is known for its excellent hemodynamic stability (minimal effect on HR/BP) but has the unique side effect of inhibiting 11-beta-hydroxylase, leading to adrenal suppression."
        },
        {
            ...
            "correctAnswer": 3,
            "rationale": "**Nitrous Oxide** (N2O) is much more soluble than nitrogen. It diffuses into air-filled spaces (like an obstructed bowel) faster than nitrogen can leave, causing rapid expansion of the space. It is contraindicated in bowel obstruction, pneumothorax, and middle ear surgery."
        },
        {
            ...
            "correctAnswer": 1,
            "rationale": "The presentation is **Malignant Hyperthermia**. The antidote is **Dantrolene**, which works by **inhibiting calcium release** from the sarcoplasmic reticulum (via ryanodine receptors), stopping the uncontrolled contraction."
        },
        {
            ...
            "correctAnswer": 2,
            "rationale": "**Ketamine** stimulates the sympathetic nervous system (increasing HR and BP), making it an excellent induction agent for patients in hypovolemic shock who need hemodynamic support. Propofol causes hypotension."
        },
        {
            ...
            "correctAnswer": 1,
            "rationale": "**Nitrous Oxide** irreversibly oxidizes the cobalt atom of Vitamin B12, which inhibits **Methionine Synthase**. This can lead to megaloblastic anemia and neurologic sequelae (subacute combined degeneration), especially in B12-deficient patients."
        }
    ],
    "flashcards": [
        {
    ...
    "ankingResource": {
        "primarySource": "BandB",
        "chapter": "Neurology > Pharmacology > Anesthetics",
        "alternatives": [
            {
                "resource": "FirstAid",
