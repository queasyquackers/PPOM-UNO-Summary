  ...
  "flashcards": [
    {
      ...
      "back": "Non-contrast CT Head",
      "tag": "Radiology"
    },
    {
      "front": "What does hyperdense (white) material on CT usually represent?",
      "back": "Bone or Acute Blood",
      "tag": "Radiology"
    },
    {
      "front": "Risk of Gadolinium in renal failure?",
      "back": "Nephrogenic Systemic Fibrosis (NSF)",
      "tag": "Pathology"
    },
    {
      "front": "Classic appearance of Abscess on contrast MRI?",
      "back": "Ring-Enhancing Lesion",
      "tag": "Radiology"
    },
    {
      "front": "Contraindication for MRI?",
      "back": "Metal Implants (Pacemaker)",
      "tag": "Safety"
    },
    {
      "front": "Best modality for Acute Ischemic Stroke (most sensitive)?",
      "back": "Diffusion Weighted MRI (DWI)",
      "tag": "Radiology"
    },
    {
      "front": "Metformin management with Contrast?",
      "back": "Hold for 48 hours (Risk of Lactic Acidosis)",
      "tag": "Pharm"
    },
    {
      "front": "Appearance of Meningioma with contrast?",
      "back": "Diffuse enhancement + Dural Tail",
      "tag": "Radiology"
    },
    {
      "front": "Gold standard for Aneurysm/AVM?",
      "back": "Conventional Angiography (DSA)",
      "tag": "Radiology"
    },
    {
      "front": "Mechanism of CT?",
      "back": "X-ray attenuation (Hounsfield Units)",
      "tag": "Physics"
    }
  ],
  "ankingResource": {
