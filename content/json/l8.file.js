window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Position of Corticospinal Tract in Brainstem?",
      "back": "Ventral (Crus Cerebri, Base Pons, Pyramids)",
      "tag": "Anatomy"
    },
    {
      "front": "Position of Medial Lemniscus vs STT?",
      "back": "Medial Lemniscus is MEDIAL; STT is LATERAL",
      "tag": "Anatomy"
    },
    {
      "front": "Function of Nucleus Ambiguus?",
      "back": "Motor Swallowing/Speech (IX, X)",
      "tag": "Neuro"
    },
    {
      "front": "Function of Nucleus Solitarius?",
      "back": "Sensory Taste/Baroreceptors (VII, IX, X)",
      "tag": "Neuro"
    },
    {
      "front": "Which CN nuclei are Somatic Motor (Midline)?",
      "back": "III, IV, VI, XII",
      "tag": "Neuro"
    },
    {
      "front": "Where does Upper Extremity DCML information travel?",
      "back": "Fasciculus/Nucleus Cuneatus (Lateral Dorsal Column)",
      "tag": "Anatomy"
    },
    {
      "front": "Tongue deviation points to?",
      "back": "Side of the Lesion (IPSI)",
      "tag": "Clinical"
    },
    {
      "front": "Peduncle connecting Pons to Cerebellum?",
      "back": "Middle Cerebellar Peduncle (MCP)",
      "tag": "Anatomy"
    },
    {
      "front": "General Rule for Brainstem Nuclei?",
      "back": "Motor Medial, Sensory Lateral",
      "tag": "Neuro"
    },
    {
      "front": "What fibers form the Medial Lemniscus?",
      "back": "Internal Arcuate Fibers (Decussation of DCML)",
      "tag": "Anatomy"
    }
  ]
});