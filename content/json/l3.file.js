window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Which proteins form Tight Junctions in the BBB?",
      "back": "Occludin, Claudin, Zona Occludens (ZO)",
      "tag": "Concept"
    },
    {
      "front": "Which brain area lacks BBB and triggers vomiting?",
      "back": "Area Postrema",
      "tag": "Anatomy"
    },
    {
      "front": "Why is Levodopa used instead of Dopamine?",
      "back": "Dopamine is polar (blocked by BBB); Levodopa crosses and converts.",
      "tag": "Pharm"
    },
    {
      "front": "Structure separating cerebral hemispheres?",
      "back": "Falx Cerebri",
      "tag": "Anatomy"
    },
    {
      "front": "Structure separating cerebrum and cerebellum?",
      "back": "Tentorium Cerebelli",
      "tag": "Anatomy"
    },
    {
      "front": "Contents of Epidural Space?",
      "back": "Middle Meningeal Artery (MMA)",
      "tag": "Clinical"
    },
    {
      "front": "Contents of Subdural Space?",
      "back": "Bridging Veins",
      "tag": "Clinical"
    },
    {
      "front": "Sign of Uncal Herniation?",
      "back": "Ipsilateral Blown Pupil (CN III compression)",
      "tag": "Pathology"
    },
    {
      "front": "Sign of Subfalcine Herniation?",
      "back": "Contralateral leg weakness (ACA compression)",
      "tag": "Pathology"
    },
    {
      "front": "Triad for Normal Pressure Hydrocephalus (NPH)?",
      "back": "Wet (Incontinence), Wobbly (Ataxia), Wacky (Dementia)",
      "tag": "Clinical"
    }
  ],
  "ankingResource": {
