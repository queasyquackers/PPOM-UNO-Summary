window.receiveLectureContent({
  ...
  "flashcards": [
    {
      "front": "Standing Flexion Test assesses which dysfunction?",
      "back": "Iliosacral Dysfunction (Innominate/Pelvic)",
      "tag": "Concept"
    },
    {
      "front": "Seated Flexion Test assesses which dysfunction?",
      "back": "Sacroiliac Dysfunction (Sacral)",
      "tag": "Concept"
    },
    {
      "front": "What does a positive StFT indicate biomechanically?",
      "back": "The PSIS on the positive side moves first and farthest because the Ilio-sacral joint is restricted (hypomobile).",
      "tag": "Concept"
    },
    {
      "front": "What is the purpose of the ASIS Compression Test?",
      "back": "Lateralization (identifying which side involved).",
      "tag": "Clinical"
    },
    {
      "front": "Which hormone causes pelvic ligament laxity in pregnancy?",
      "back": "Relaxin",
      "tag": "Glossary"
    },
    {
      "front": "Axis of motion for Iliosacral Dysfunction?",
      "back": "Inferior Transverse Axis",
      "tag": "Concept"
    },
    {
      "front": "Axis of motion for Sacroiliac Dysfunction?",
      "back": "Middle Transverse Axis",
      "tag": "Concept"
    },
    {
      "front": "Anatomy: What 3 bones fuse to form the Innominate?",
      "back": "Ilium, Ischium, Pubis",
      "tag": "Glossary"
    },
    {
      "front": "In StFT, if Right PSIS moves higher, which side is dysfunctional?",
      "back": "Right side",
      "tag": "Clinical"
    },
    {
      "front": "Normal result for ASIS Compression Test?",
      "back": "Springy/Resilient feel (Restrictions feel rigid/board-like).",
      "tag": "Clinical"
    }
  ]
,
