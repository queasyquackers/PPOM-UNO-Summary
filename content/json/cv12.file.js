window.receiveLectureContent({
  ...
  "lecturer": "Sheldon C. Yao, DO, FAAO",
  "pdf": "content/CV12_HighYield_Render.pdf",
  "content": `
# Lecture #12: Sphenobasilar Synchondrosis (SBS) Strain Patterns
...
| --- | --- | --- |
| CN I (Olfactory) | Cribriform plate | Ethmoid |
| CN II (Optic) | Optic canal | Sphenoid |
| CN III, IV, V1 | Superior orbital fissure | Sphenoid |
| CN V2 | Foramen rotundum | Sphenoid |
| CN V3 | Foramen ovale | Sphenoid |
| CN VI (Abducens) | Superior orbital fissure | Sphenoid + petrosphenoid ligament |
| CN VII, VIII | Internal acoustic meatus | Temporal |
...
`,
  "flashcards": [
    ...
    { "front": "How many parts are the newborn occiput, sphenoid, temporal bone, and maxillae in at birth?", "back": "Occiput in 4 parts, sphenoid in 3, temporal in 3, maxillae in 2 — plus 6 fontanelles and NO mastoid process (it develops later from sternocleidomastoid traction as the infant lifts the head).", "tag": "Concept" },
    { "front": "Which cranial bones form in cartilage and which form in membrane?", "back": "The bones of the cranial base (sphenoid, occiput) form in cartilage — the 'cranial vertebrae' (occiput = C0, sphenoid = C0-prime). The vault bones (frontal, parietal, squamous temporal and occiput) form in membrane.", "tag": "Glossary" },
    { "front": "What is the core link, and how does the sacrum move with craniosacral flexion and extension?", "back": "The cranial dura continues down the spinal canal, attaching at C2-C3 and the sacrum. Craniosacral flexion → sacrum counternutates (rotates posteriorly); craniosacral extension → sacrum nutates (rotates anteriorly).", "tag": "Concept" },
    { "front": "How are SBS strain patterns generally named?", "back": "For the direction of motion of the basisphenoid relative to the basiocciput — like naming a spinal segment for the vertebra above (the sphenoid is the 'segment above').", "tag": "Concept" },
    { "front": "Which SBS strain patterns are physiologic and which are non-physiologic?", "back": "Physiologic (opposite-direction, gear-like rotation): flexion, extension, torsion, sidebending-rotation. Non-physiologic (same-direction rotation = shear; usually traumatic): vertical shears, lateral shears, and SBS compression.", "tag": "Concept" },
    { "front": "Describe SBS flexion: axes, motion, and head shape.", "back": "Two parallel transverse axes; sphenoid rotates anteriorly, occiput posteriorly; SBS rises; paired bones externally rotate. Head shape: increased transverse diameter, decreased AP and vertical diameter (wide 'Ernie' head).", "tag": "Concept" },
    { "front": "What do your fingers feel in the vault hold during cranial flexion vs. extension?", "back": "Flexion: fingers spread apart and move inferiorly toward the feet. Extension: fingers come together and move superiorly toward the vertex. The palms do not twist or approximate.", "tag": "Concept" },
    { "front": "What axes and motions create a sidebending-rotation strain, and how is it named?", "back": "Three axes: sphenoid and occiput rotate in OPPOSITE directions about two parallel vertical axes (sidebending) and in the SAME direction about an AP axis (rotation toward the convexity, bringing it inferior). Named for the side of the convexity — the side where fingers feel 'down and out.'", "tag": "Concept" },
    { "front": "What axis defines a torsion strain, and how is it named?", "back": "One anteroposterior axis from nasion to opisthion; sphenoid and occiput rotate opposite directions. Named for the side of the HIGH (superior) greater wing of the sphenoid — the hand that rolls cephalad marks the torsion side.", "tag": "Concept" },
    { "front": "How is a lateral strain named, and what does it feel like in the vault hold?", "back": "Named for the direction the basisphenoid moves — followed by your PINKY fingers. Index fingers deviate toward the greater wings (opposite side). Both hands tilt the same way, forming a 'parallelogram head.' Right lateral strain = pinkies right, greater wing feels left.", "tag": "Concept" },
    { "front": "Distinguish superior from inferior vertical strain by palpation.", "back": "Both use the flexion/extension transverse axes but with SAME-direction rotation. Superior vertical strain (basisphenoid high): both hands rotate anteriorly, fingers feel like they rotate DOWN toward the table. Inferior vertical strain (basisphenoid low): both hands rotate posteriorly, fingers rotate UP toward the ceiling.", "tag": "Concept" },
    { "front": "What is the classic palpatory finding of SBS compression?", "back": "The 'bowling ball head': dense, compressed, relatively heavy when the operator tries to lift, with minimal excursion — the PRM is barely palpable. Usually from major trauma jamming the SBS toward midline.", "tag": "Clinical" },
    { "front": "Which cranial nerves exit through the jugular foramen, and why does the occipitomastoid suture matter?", "back": "CN IX, X, and XI exit the jugular foramen, formed where the occipital condylar parts meet the petrous temporal bone (OM suture). About 90% of the head's venous blood also drains through it. Restriction can contribute to feeding/swallowing problems (IX, X), colic (vagus), and torticollis-related findings (XI → SCM).", "tag": "Clinical" },
    { "front": "What are the absolute and relative contraindications to OCMM?", "back": "Absolute: acute intracranial bleeding, skull fracture, acute cerebrovascular accident. Relative: coagulopathies, space-occupying lesion in the cranium, increased intracranial pressure.", "tag": "Clinical" }
  ],
  "questions": [
    {
      "question": "While holding a patient's head in the vault hold, an osteopathic student feels the fingers of both hands spread apart and drift inferiorly toward the patient's feet, then return. The palms neither twist nor approximate. Which phase or pattern of cranial motion is being palpated?",
      "options": ["A. Extension - the fingers should approximate and move toward the vertex", "B. Flexion - the greater wings and occipital squama move inferiorly as the SBS rises", "C. Torsion - one hand rolls toward the ceiling while the other rolls toward the floor", "D. Lateral strain - both hands tilt to the same side forming a parallelogram", "E. Inferior vertical strain - all fingers rotate up toward the ceiling"],
      "answer": "B",
      "rationale": "In cranial flexion the sphenoid rotates anteriorly and the occiput posteriorly about two parallel transverse axes; the SBS rises while the greater wings and occipital squama move inferiorly, so the operator's fingers spread laterally (paired bones externally rotate) and move toward the feet. Extension is the reverse (fingers together, toward the vertex). Torsion, lateral strain, and vertical strain each produce hand rolls or tilts, not a pure spread-and-descend.",
      "hidden": true
    },
    {
      "question": "In a vault hold, the physician's right index finger (resting on the right greater wing of the sphenoid) rolls cephalad toward the ceiling while the entire left hand rolls toward the floor, as if a pen between the hands were being rotated without tilting. Which strain pattern is present?",
      "options": ["A. Left torsion", "B. Right sidebending-rotation", "C. Superior vertical strain", "D. Right torsion", "E. Right lateral strain"],
      "answer": "D",
      "rationale": "Torsion occurs about a single AP axis from nasion to opisthion with the sphenoid and occiput rotating in opposite directions, and it is named for the side of the high greater wing. The hand (index finger on the greater wing) that rolls cephalad marks the side of torsion — here the right, so this is a right torsion.",
      "hidden": true
    },
    {
      "question": "Which of the following correctly describes the mechanics that make a lateral strain a NON-physiologic pattern?",
      "options": ["A. The sphenoid and occiput rotate in the same direction about two parallel vertical axes, shearing the SBS", "B. The sphenoid and occiput rotate in opposite directions about two parallel vertical axes, creating a convexity", "C. The sphenoid and occiput rotate in opposite directions about one AP axis from nasion to opisthion", "D. The sphenoid and occiput rotate in opposite directions about two parallel transverse axes", "E. The SBS is jammed toward midline with loss of all palpable motion"],
      "answer": "A",
      "rationale": "Non-physiologic strains occur when the two bones rotate in the SAME direction — like gears grinding — creating a shear. In a lateral strain this occurs about two parallel vertical axes, producing the 'parallelogram head.' Option B describes the sidebending component of a physiologic sidebending-rotation; C describes torsion; D describes flexion/extension; E describes SBS compression.",
      "hidden": true
    },
    {
      "question": "A 2-month-old girl with congenital torticollis has a spasmed sternocleidomastoid muscle. Irritation of the motor nerve to this muscle would be expected at which anatomic location?",
      "options": ["A. Superior orbital fissure of the sphenoid", "B. Internal acoustic meatus of the temporal bone", "C. Cribriform plate of the ethmoid", "D. Hypoglossal canal near the foramen magnum", "E. Jugular foramen at the occipitomastoid suture"],
      "answer": "E",
      "rationale": "The sternocleidomastoid is innervated by CN XI (spinal accessory), which exits through the jugular foramen — formed where the occipital condylar parts meet the petrous portion of the temporal bone at the occipitomastoid suture. CN IX and X exit with it, and roughly 90% of the head's venous drainage passes through this foramen, making OM suture restriction clinically significant in newborns whose occiput is still in four parts.",
      "hidden": true
    },
    {
      "question": "A physician plans osteopathic cranial manipulative medicine for an elderly patient. Which of the following findings is an ABSOLUTE contraindication to treatment?",
      "options": ["A. Warfarin-related coagulopathy", "B. A known meningioma occupying space in the cranium", "C. Acute intracranial bleeding", "D. Chronically increased intracranial pressure", "E. Chronic post-concussion syndrome"],
      "answer": "C",
      "rationale": "The absolute contraindications to OCMM are acute intracranial bleeding, skull fracture, and acute cerebrovascular accident. Coagulopathies, space-occupying cranial lesions, and increased intracranial pressure are relative contraindications, and post-concussion syndrome is actually a studied application of cranial treatment.",
      "hidden": true
    }
  ],
  "anking": [
    { "match": "Cranial nerve foramina and skull exits", "resources": "CN I cribriform plate; CN II optic canal; CN III/IV/V1/VI superior orbital fissure; V2 rotundum; V3 ovale; VII/VIII internal acoustic meatus; IX/X/XI jugular foramen; XII hypoglossal canal" },
    { "match": "Cranial nerve functions (CN VI abducens - lateral rectus; CN XI - SCM)", "resources": "Extraocular muscle innervation LR6 SO4, spinal accessory to sternocleidomastoid and trapezius" },
    { "match": "Vagus nerve parasympathetic innervation", "resources": "CN X rest-and-digest supply to heart, lungs, and GI tract" },
    { "match": "Sternocleidomastoid actions and torticollis", "resources": "SCM sidebends toward and rotates away; congenital torticollis" },
    { "match": "OMM cranial strain patterns (COMLEX)", "resources": "SBS flexion/extension, torsion, sidebending-rotation, vertical and lateral shears, compression; primary respiratory mechanism; CRI" }
  ],
  "ankingResource": {
    "primarySource": "FirstAid",
    "chapter": "Neurology > Cranial Nerves & Skull Foramina",
    "alternatives": [
      { "resource": "BandB", "chapter": "Neurology > Cranial Nerves" },
      { "resource": "Physeo", "chapter": "Neuroanatomy > Cranial Nerves & Brainstem" },
      { "resource": "Bootcamp", "chapter": "Anatomy > Head & Neck > Skull Foramina" }
    ]
  },
  "pearls": [
    { "title": "Gears cannot turn the same way", "content": "Physiologic SBS patterns (flexion, extension, torsion, sidebending-rotation) have the sphenoid and occiput rotating in OPPOSITE directions. Non-physiologic patterns (vertical shear, lateral shear, compression) rotate in the SAME direction — a trauma-associated shear that disrupts the SBS midline." },
    { "title": "Name it like the spine", "content": "SBS strains are generally named for the motion of the basisphenoid relative to the basiocciput — the sphenoid is the 'segment above,' exactly like naming T1 on T2. Torsion is named for the HIGH greater wing; sidebending-rotation for the side of CONVEXITY; lateral strain for the direction the basisphenoid (your pinkies) moves." },
    { "title": "Vault hold cheat sheet", "content": "Flexion: fingers spread and drop toward the feet. Extension: fingers narrow and rise toward the vertex. Torsion: hands roll opposite ways (cephalad hand names it). Sidebending-rotation: 'down and out' on the convex side. Vertical strains: all fingers rotate down toward the table (superior) or up toward the ceiling (inferior). Lateral strain: parallelogram tilt. Compression: bowling ball — dense, heavy, no motion." },
    { "title": "The core link", "content": "Cranial dura attaches to C2-C3 and the sacrum. Craniosacral flexion → sacral counternutation (posterior rotation); extension → nutation. Head strains can drive spine/sacrum symptoms and vice versa — a hard fall on the buttocks can cause headaches, and a stuck postpartum sacrum drags on the whole system." },
    { "title": "Newborn skull numbers", "content": "At birth: occiput in 4 parts, sphenoid in 3, temporal in 3, maxillae in 2, six fontanelles, and no mastoid process (it forms later from SCM traction as the infant lifts its head — bone develops according to the forces placed on it)." },
    { "title": "Jugular foramen is prime real estate", "content": "CN IX, X, and XI exit the jugular foramen at the occipitomastoid suture, and ~90% of the head's venous blood drains through it. Newborn condylar compression here links to feeding and swallowing problems (IX/X, plus XII at the hypoglossal canal), colic (vagus), and torticollis (XI → SCM)." },
    { "title": "Back to sleep, tummy to play", "content": "The 1992 AAP supine-sleep recommendation cut SIDS by more than half but increased positional plagiocephaly. Encourage supervised tummy time; helmets require ~23 h/day wear and recent data question their benefit." },
    { "title": "Plagiocephaly's must-not-miss mimic", "content": "If a misshaped infant head shows no improvement with treatment, suspect craniosynostosis (early suture closure) and refer to pediatric neurosurgery." },
    { "title": "CN VI is anatomically vulnerable", "content": "The abducens nerve takes a long, angulated course and passes beneath the petrosphenoidal (Gruber's) ligament between the petrous temporal bone and sphenoid — compression or stretch here (as in Duane retraction syndrome discussions) impairs lateral rectus function and eye abduction." },
    { "title": "Trauma vector predicts the pattern", "content": "A midline blow (chin strike, windshield) suggests a vertical strain or SBS compression; lateral forces and positional molding suggest lateral strains. Vertical and lateral shears plus compression are the non-physiologic, usually traumatic patterns." },
    { "title": "OCMM contraindications", "content": "Absolute: acute intracranial bleeding, skull fracture, acute cerebrovascular accident. Relative: coagulopathies, space-occupying cranial lesions, increased intracranial pressure." },
    { "title": "Why treat the cranium", "content": "Goals of treating cranial strains: restore motion, reduce cranial nerve compression, balance the autonomics, enhance circulation and venous sinus drainage, improve glymphatic drainage (superior sagittal sinus), and improve paranasal sinus drainage (the maxillary ostium drains higher than the cavity floor)." }
  ],
  "mindmap": `
## SBS Strain Patterns
...
- **At birth**: occiput 4 parts, sphenoid 3, temporal 3, maxillae 2
- **Fontanelles**: six; sutures present, not overlapping
- **No mastoid process**: forms from SCM traction when infant lifts head
- **Molding**: head compresses through birth canal; C-section babies still molded in utero
- **Base**: forms in cartilage (occiput = C0, sphenoid = C0-prime)
- **Vault**: forms in membrane (frontal, parietal, squamous temporal/occiput)
- **Dura**: bones guided within dura; treatment targets dural restrictions

### Primary Respiratory Mechanism

- **1**: Inherent motility of brain and spinal cord (coiling/uncoiling)
- **2**: Fluctuation of CSF
- **3**: Movement of intracranial and intraspinal membranes
- **4**: Articular mobility of cranial bones (serrated sutures)
- **5**: Involuntary mobility of sacrum between the ilia
- **Sutherland**: self-experimentation; tried to disprove motion, confirmed it
- **Evidence**: amplified brain MRI; NASA CSF research; Hollis King article
- **Rate**: flexion/extension cycles ~6-12 per minute

### Diagnosis & Contacts

- **Holds**: vault, fronto-occipital, occipital (Becker)
- **Vault hold**: index on greater wing, middle/ring around ear, pinky on occiput
- **Principle**: vault accommodation reveals base strain (house/basement analogy)

### SBS Anatomy

- **SBS**: cartilaginous articulation of sphenoid and occiput
- **Location**: center of cranial base - excellent reference point
- **Trauma**: cranium directs forces to center for absorption
- **Motions**: flexion/extension, sidebending, rotation (like spine)
- **Naming**: basisphenoid relative to basiocciput (segment above rule)

### Gear Motion & Core Link

- **Gear-like**: midline bones rotate opposite directions
- **Chain**: sphenoid drives ethmoid, vomer; midline drives paired bones ER/IR
- **Core link**: dura attaches C2-C3 and sacrum
- **Cranial flexion**: sacrum counternutates (posterior rotation)
- **Cranial extension**: sacrum nutates (anterior rotation)
- **Other drivers**: fascial pull from below, local cranial dysfunction, spinal/pelvic asymmetry

### Physiologic Patterns

- **Flexion**: 2 transverse axes; sphenoid anterior, occiput posterior; SBS rises; paired bones ER; wide Ernie head; fingers spread + inferior
- **Extension**: sphenoid posterior, occiput anterior; SBS drops; paired bones IR; tall narrow Bert head; fingers narrow + superior
- **Torsion**: 1 AP axis nasion-opisthion; opposite rotation; named for HIGH greater wing; hands roll opposite directions
- **Sidebending/Rotation**: 2 vertical axes opposite (sidebend) + 1 AP axis same (rotation); named for convexity; convex side down and out

### Non-Physiologic Patterns

- **Rule**: sphenoid and occiput rotate SAME direction = shear; traumatic, symptomatic
- **Superior vertical strain**: transverse axes; both rotate anteriorly; basisphenoid high; fingers rotate toward table
- **Inferior vertical strain**: both rotate posteriorly; basisphenoid low; fingers rotate toward ceiling
- **Lateral strain**: 2 vertical axes same direction; parallelogram head; named for basisphenoid (pinkies); index toward greater wings
- **Compression**: SBS jammed toward midline; bowling ball head; dense, heavy, minimal PRM

### Cranial Nerve Exits

- **CN I**: cribriform plate - ethmoid (post-COVID anosmia case)
- **CN II**: optic canal - sphenoid
- **CN III, IV, V1, VI**: superior orbital fissure - sphenoid
- **CN V2**: foramen rotundum; **V3**: foramen ovale - sphenoid (trigeminal neuralgia)
- **CN VI**: also under petrosphenoidal (Gruber) ligament - Duane syndrome link
- **CN VII, VIII**: internal acoustic meatus - temporal (Bell palsy; tinnitus/vertigo)
- **CN IX, X, XI**: jugular foramen - OM suture; 90% venous drainage
- **CN XII**: hypoglossal canal - condylar jamming affects feeding

### Clinical Cases

- **Case 1**: 2-month-old torticollis + misshaped head; tight SCM (CN XI); right SBR; resolved by visit 3
- **Case 2**: 6-year-old Duane retraction syndrome; right lateral strain; improved gaze after OMM
- **Case 3**: 50-year-old chin blow; tinnitus + dizziness; CN VIII; vertical strain pattern
- **Plagiocephaly**: asymmetric flattening; back-to-sleep 1992 cut SIDS >50% but raised incidence; tummy time
- **Brachycephaly**: shortened AP diameter (flat-head syndrome)
- **Craniosynostosis**: early suture closure; no improvement with OMT - refer pediatric neurosurgery

### Treatment Rationale & Safety

- **Goals**: restore motion, decompress cranial nerves, balance ANS
- **Drainage**: venous sinus, glymphatic (superior sagittal sinus), paranasal sinuses
- **Absolute contraindications**: acute intracranial bleed, skull fracture, acute CVA
- **Relative contraindications**: coagulopathy, space-occupying lesion, increased ICP
- **Applications**: TMJ/dental, vagal/digestive, concussion, headaches, pediatrics, Parkinson research
`
});
