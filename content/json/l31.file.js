window.receiveLectureContent({
  ...
  "flashcards": [
    ...
    {
      "front": "Dopamine effect on D1?",
      "back": "Excitatory (Direct Pathway) -> GO",
      "tag": "Neuro"
    },
    {
      "front": "Dopamine effect on D2?",
      "back": "Inhibitory (Indirect Pathway) -> STOP the NO-GO -> GO",
      "tag": "Neuro"
    },
    {
      "front": "Parkinson's Symptoms TRAP?",
      "back": "Tremor (Rest), Rigidity, Akinesia/Bradykinesia, Postural Instability",
      "tag": "Neuro"
    },
    {
      "front": "Structure degenerated in Huntington's?",
      "back": "Caudate Nucleus (+ Putamen)",
      "tag": "Neuro"
    }
  ]
});