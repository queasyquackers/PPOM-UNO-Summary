...
## 1. Reticular Formation Overview(Slide 6 - 7)
...
`,
        pearls: [
            {
                ...
                content: "**Decorticate:** Flexor posturing (Hands to **C**ore). Lesion **Above** Red Nucleus.\\n**Decerebrate:** Extensor posturing (worse). Lesion **Below** Red Nucleus."
            },
            {
                title: "Locating Neurotransmitters",
                content: "**Raphe Nuclei** = Serotonin (5-HT).\\n**Locus Coeruleus** = Norepinephrine (NE).\\n**Substantia Nigra** = Dopamine (DA).\\n**Tuberomammillary Nucleus** = Histamine."
            },
            {
                title: "Locked-in Syndrome",
                content: "Caused by a **Ventral Pontine** stroke (Basilar artery). The **ARAS** is spared (Tegmentum), so the patient is fully awake/aware but quadriplegic. Can only blink or move eyes vertically."
            },
            {
                title: "Narcolepsy Mechanism",
                content: "Caused by a deficiency of **Hypocretin (Orexin)** producing neurons in the **Lateral Hypothalamus**."
            },
            {
        ...
        questions: [
            {
                question: "A patient presents with 'locked-in' syndrome following a stroke. They are fully aware but cannot move their limbs or speak. Which structure is most likely spared, preserving their consciousness?",
                options: [
                    "Basis Pontis",
                    "Corticospinal Tracts",
                    "Reticular Activating System (Tegmentum)",
                    "Medullary Pyramids",
                    "Internal Capsule"
                ],
                correctAnswer: 2,
        ...
        flashcards: [
            {
                front: "Location of Serotonin (5-HT) cell bodies",
                back: "Raphe Nuclei",
                tag: "Neurochemistry"
            },
            {
                front: "Location of Norepinephrine (NE) cell bodies",
                back: "Locus Coeruleus",
                tag: "Neurochemistry"
            },
            {
                front: "Location of Dopamine (DA) cell bodies (Midbrain)",
                back: "Substantia Nigra & Ventral Tegmental Area (VTA)",
                tag: "Neurochemistry"
            },
            {
                front: "Location of Histamine cell bodies",
                back: "Tuberomammillary Nucleus (Hypothalamus)",
                tag: "Neurochemistry"
            },
            {
                front: "Lesion location for Decorticate Rigidity",
                back: "Above the Red Nucleus (Midbrain)",
                tag: "Neurology"
            },
            {
                front: "Lesion location for Decerebrate Rigidity",
                back: "At or Below the Red Nucleus",
                tag: "Neurology"
            },
            {
                front: "Which is worse: Decorticate or Decerebrate?",
                back: "Decerebrate (indicates deeper brainstem damage)",
                tag: "Neurology"
            },
            {
                front: "Neurotransmitter deficiency in Narcolepsy",
                back: "Hypocretin (Orexin)",
                tag: "Neurology"
            },
            {
                front: "Area spared in Locked-in Syndrome",
                back: "Reticular Activating System (Tegmentum) & Vertical Eye Movements",
                tag: "Neurology"
            },
            {
                front: "Structure responsible for Descending Pain Modulation",
        ...
        ankingResource: {
            ...
            chapter: "Neurology > Brainstem > Brainstem Anatomy",
            alternatives: [
                { resource: "FirstAid", chapter: "Neurology > Pathology > Coma & Sleep" },
                { resource: "Pathoma", chapter: "CNS" }
            ]
        },
        mindmap: `
...
`
    },
    {
        ...
        prev: "l24",
        next: "l26",
        pdf: "pdfs/Lecture # 25. J. Xie, Ph.D. (PPT)-1.pdf",
        ...
        summary: `
# Lecture 25: Limbic System - Neuroanatomy, Regional Function and Limbic Pathology
...
*   ** The "5 F's" Mnemonic:**
    ...
    *   ** F ** eeling(Emotion)
    *   ** F ** ornicating(Sexual behavior)
    :::

### Key Structures
While the exact composition is debated, the "Big 3" universally agreed - upon components are:
1. ** Cingulate Gyrus:** Emotional processing of sensory input.
2. ** Hippocampal Formation:** Memory consolidation and spatial navigation.
3. ** Amygdala:** Fear, anger, and emotional association.

Other components include the ** Mammillary Bodies ** (Hypothalamus), ** Anterior Thalamic Nuclei **, ** Septal Area ** (Reward), and ** Orbitofrontal Cortex ** (Social behavior).
...
Discovered by James Papez(1937), this is the fundamental circuit for ** Episodic Memory Consolidation ** and emotional expression.

::: highyield
    ** The Papez Circuit Pathway **
        1. ** Hippocampus ** (Subiculum)
2.  $\\xrightarrow{ \\text{ Fornix } } $ ** Mammillary Bodies **
...
*   ** Presentation:**
    ...
    4. ** Hypermetamorphosis:** Compulsive visual exploration of objects.
    5. ** Visual Agnosia:** Psychic blindness(inability to recognize emotional significance of objects).
:::

## 6. Memory Disorders(Slide 36 - 39)
...
`,
        pearls: [
            {
                title: "The 5 F's of the Limbic System",
            ...
            },
            {
                ...
                content: "Confusion, Ataxia, Nystagmus/Ophthalmoplegia ('**CAN** of Beer'). Caused by **B1 (Thiamine)** deficiency harming **Mammillary Bodies**."
            },
            {
                title: "Procedural vs. Declarative Memory",
                content: "Hippocampal damage (Patient H.M.) destroys **Declarative** (New facts/events) but spares **Procedural** (Skills/Habits - Basal Ganglia/Cerebellum)."
            },
            {
                title: "HSV Encephalitis Target",
                content: "HSV-1 loves the **Medial Temporal Lobe**. Causes hemorrhagic necrosis, fever, seizures, and bizarre behavior."
            }
        ],
        questions: [
            {
                question: "A chronic alcoholic is brought to the ER with confusion, ataxia, and ophthalmoplegia. MRI reveals degeneration of the mammillary bodies. Which nutrient deficiency is responsible?",
                options: [
                ...
                correctAnswer: 1,
                rationale: "**Wernicke-Korsakoff Syndrome** is caused by **Thiamine (B1)** deficiency, common in alcoholics. It damages the **Mammillary Bodies** and medial thalamus. The triad is Confusion, Ataxia, Nystagmus."
            },
            {
                question: "A patient undergoes bilateral temporal lobectomy for intractable epilepsy. Post-operatively, he interacts with objects by putting them in his mouth, displays inappropriate sexual behavior toward staff, and appears completely fearless. Which structure's absence explains these symptoms?",
                options: [
                    "Hippocampus",
                    "Cingulate Gyrus",
                    "Amygdala",
                ...
                correctAnswer: 2,
                rationale: "This is **Kluver-Bucy Syndrome** (Hyperorality, Hypersexuality, Placidity). It is caused by bilateral lesions to the **Amygdala**."
            },
            {
                question: "A 65-year-old male with a history of cardiac arrest 2 weeks ago now presents with severe short-term memory loss. He cannot remember what he ate for breakfast or the names of his new doctors. Which specific neuronal population was likely damaged by hypoxia?",
                options: [
                    "Purkinje cells of the Cerebellum",
                    "Anterior Horn cells of Spinal Cord",
                    "CA1 Pyramidal cells of the Hippocampus",
                    "Dopaminergic neurons of Substantia Nigra",
                    "Cholinergic neurons of Nucleus Basalis"
                ],
                correctAnswer: 2,
                rationale: "The **CA1 Pyramidal neurons** of the **Hippocampus** (Sommer's sector) are the most sensitive cells in the brain to **hypoxic-ischemic injury**. Damage here causes anterograde amnesia."
            },
            {
                question: "In the Papez circuit, fibers travel from the mammillary bodies to the anterior nucleus of the thalamus via which tract?",
                options: [
                    "Fornix",
                    "Cingulum",
                    "Stria Terminalis",
                ...
                correctAnswer: 3,
                rationale: "The **Mammillothalamic Tract** connects the **Mammillary Bodies** to the **Anterior Nucleus of the Thalamus**."
            },
            {
                question: "Patient H.M. had his medial temporal lobes removed. He could no longer form new memories of events (Episodic), but he could learn to solve puzzles (Procedural). Which structure is primarily responsible for the *preserved* procedural memory?",
                options: [
                    "Hippocampus",
                    "Basal Ganglia",
                    "Amygdala",
                ...
                correctAnswer: 1,
                rationale: "**Procedural Memory** (skills/habits) is processed by the **Basal Ganglia**, Cerebellum, and Motor Cortex, which were intact in H.M. The Hippocampus (removed) drives Declarative/Episodic memory."
            }
        ],
        flashcards: [
            {
                front: "Which limbic structure is responsible for spatial navigation?",
                back: "**Right** Hippocampus",
                tag: "Physiology"
            },
            {
                front: "What is the classic triad of Wernicke's Encephalopathy?",
                back: "Confusion, Ataxia, Nystagmus/Ophthalmoplegia ('**CAN** of Beer')",
                tag: "Pathology"
            },
            {
                front: "Bilateral lesions of the Amygdala cause what syndrome?",
                back: "**Kluver-Bucy Syndrome** (Placidity, Hyperorality, Hypersexuality)",
                tag: "Pathology"
            },
            {
                front: "What is the major output tract of the Hippocampus?",
                back: "The **Fornix**",
                tag: "Anatomy"
            },
            {
                front: "Which neurons are most sensitive to cerebral hypoxia?",
                back: "**CA1 Pyramidal neurons** of the Hippocampus",
                tag: "Pathology"
            },
            {
                front: "What is the primary neurotransmitter deficiency in Alzheimer's Disease?",
                back: "**Acetylcholine (ACh)** (due to loss of Nucleus Basalis of Meynert)",
                tag: "Pathology"
            },
            {
                front: "HSV-1 Encephalitis typically affects which brain region?",
                back: "**Medial Temporal Lobes** (Limbic Cortex)",
                tag: "Pathology"
            },
            {
            ...
            {
                front: "What connects the Mammillary Bodies to the Anterior Thalamus?",
                back: "**Mammillothalamic Tract**",
                tag: "Anatomy"
            },
            {
                front: "What defines Anterograde Amnesia?",
                back: "Inability to form **NEW** memories (Old memories intact)",
                tag: "Pathology"
            }
        ],
        ankingResource: {
            ...
            alternatives: [
                { resource: "FirstAid", chapter: "Neurology > Anatomy > Limbic System" },
...
### Mental Status
    *   ** GCS **: EVM(4 - 5 - 6).Max 15, Min 3.
    ...
    },
    {
        id: "l27",
        summary: `
# Lecture 27: OMM Lab 17 Prep - Pelvic Counterstrain & HVLA
...
`,
        pearls: [
            {
                title: "Psoas Counterstrain Position",
                content: "**F-S**T**-R**A**:\\n**F**lexed, **S**idebent **T**oward, **R**otated **A**way."
            },
            {
                title: "Counterstrain Hold Time",
                content: "**90 Seconds** is the standard hold time for Counterstrain."
            },
            {
                title: "Inguinal Counterstrain",
                content: "**F-ADD-IR**:\\n**F**lexed, **ADD**ucted, **I**nternally **R**otated. (Common 'crossing legs' position)."
            },
            {
                title: "Anterior Innominate Findings",
                content: "**ASIS Lower**, **PSIS Higher** on the affected side."
            },
            {
                title: "Posterior Innominate Findings",
                content: "**ASIS Higher**, **PSIS Lower** on the affected side."
            }
        ],
        questions: [
            {
                question: "A patient feels soreness the day after a counterstrain treatment. How should this be managed?",
                options: [
                    "Immediate ER referral",
                    "Repeat the treatment immediately",
                    "Reassurance and hydration (Normal reaction)",
                    "Prescribe Opioids",
                    "Apply Heat only"
                ],
                correctAnswer: 2,
            ...
            },
            {
                ...
                options: [
                    "Extension, Sidebend Away, Rotate Toward",
                    "Flexion, Sidebend Away, Rotate Toward",
                    "Flexion, Sidebend Toward, Rotate Away",
                    "Extension only",
                    "Flexion only"
                ],
                correctAnswer: 2,
        ...
        flashcards: [
            {
                front: "Psoas Counterstrain Setup",
                back: "F-ST-RA (Flex, SB Toward, Rot Away)",
                tag: "OMM"
            },
            {
                front: "Iliacus Counterstrain Setup",
                back: "Frog Leg (Flex + External Rotation)",
                tag: "OMM"
            },
            {
                front: "Inguinal Counterstrain Setup",
                back: "F-ADD-IR (Flex, Adduct, Int Rotate)",
                tag: "OMM"
            },
            {
                front: "Counterstrain Hold Time",
                back: "90 Seconds",
                tag: "OMM"
            },
            {
                front: "Counterstrain Mechanism",
                back: "Silent Muscle Spindles (Gamma Gain)",
                tag: "OMM"
            },
            {
                front: "Anterior Innominate Diagnosis",
                back: "ASIS Low, PSIS High",
                tag: "OMM"
            },
            {
                front: "Posterior Innominate Diagnosis",
                back: "ASIS High, PSIS Low",
                tag: "OMM"
            },
            {
                front: "Absolute Contraindication to CS",
                back: "No Consent / No Dysfunction",
                tag: "OMM"
            },
            {
                front: "Relative Contraindication to CS",
                back: "Osteoporosis / Severe Illness",
                tag: "OMM"
            },
            {
                front: "Post-CS Soreness Duration",
                back: "1-2 Days (Normal)",
                tag: "OMM"
            }
        ],
        ankingResource: {
...
`
    },
    {
        id: "l28",
        summary: `
# Lecture 28: Anatomy & Physiology of the Neocortex
...
`,
        ...
        ankingResource: {
            ...
            alternatives: [
                { resource: "FirstAid", chapter: "Neurology > Anatomy > Lobes" },
                { resource: "BandB", chapter: "Neurology > Cerebrum" }
            ]
        },
        mindmap: `
...
`
    },
    {
        ...
        summary: `# Lecture #59: History and Physical Exam of the Aging Patient

**Lecturer:** P. Ryo, D.O.
**Session:** Lecture #59

## The Aging Population and Demographics (Slide 2-5)

The global population is undergoing a significant demographic shift, with the number of older adults increasing rapidly. By 2050, the U.S. population over 65 is expected to nearly double. This "epidemiologic transition" means that non-communicable chronic diseases are replacing infectious diseases as the primary burden of illness.

Because of this shift, there is a concomitant change in the "dependency ratio"—the ratio of those in the workforce to those depending on it (children, retirees). As the population ages, the demand for medical care, social services, and pension systems increases, often straining available resources.

## General Principles of Aging (Slide 6)

Geriatric medicine focuses on care for those >65 years old (with "Oldest Old" being >80). There are four fundamental principles that govern the physiology and clinical presentation of the aging patient:

1.  **Homeostatic Decline:** Organ reserves decrease, making patients less able to tolerate stress (illness, injury).
2.  **Multifactorial Comorbidities:** Patients rarely have just one problem; conditions interact.
3.  **Polypharmacy:** Multiple medications increase the risk of adverse drug events and interactions.
4.  **Atypical Presentation:** Disease often presents non-specifically (e.g., confusion instead of fever/pain).

## Physiological Changes of Aging (Slide 7-12)

Aging affects every organ system, leading to a progressive decline in functional reserve. This "homeostenosis" means that while resting function may be preserved, the body's ability to respond to maximal demand is reduced.

### Cardiovascular System
-   **Vascular Stiffening:** The aorta and arteries become rigid (arteriosclerosis), leading to increased systolic blood pressure and widened pulse pressure.
-   **Cardiac Function:** Maximal heart rate declines due to loss of pacemaker cells. There is a decreased response to beta-adrenergic stimulation.
-   **Structural Changes:** Left ventricular hypertrophy (mild) can occur to compensate for increased afterload.
-   **Clinical Finding:** An **S4 heart sound** is a common and often *normal* finding in healthy elderly adults due to decreased ventricular compliance (atrial kick pushing against a stiff ventricle).

### Respiratory System
-   **Mechanical Changes:** Chest wall stiffening and kyphosis reduce compliance.
-   **Lung Parenchyma:** Loss of elastic recoil causes air trapping and increased residual volume. Alveolar surface area decreases, reducing gas exchange capacity.
-   **Protective Mechanisms:** Cough reflex is blunted, increasing the risk of aspiration and pneumonia.

:::correlate
Atelectasis & Pneumonia

- **Pathophysiology:** Decreased lung elasticity, weaker respiratory muscles, and kyphosis lead to poor aeration. Blunted cough reflex enables aspiration.
- **Presentation:** Fever may be absent. Tachypnea or confusion may be the only signs.
- **Risk Factors:** Immobility, hospital admission, dysphagia.
- **Lecturer's Point:** Because physiologic reserves are low, a respiratory infection can rapidly lead to failure.
:::

### Gastrointestinal System
-   **Sensation:** Blunted peritoneal signs. A patient with an acute abdomen (e.g., appendicitis, diverticulitis) may have minimal guarding or rebound tenderness.
-   **Motility:** generally slows, leading to constipation.
-   **Oral Health:** Gingival recession and decreased saliva (xerostomia) increase the risk of caries and periodontal disease, affecting nutrition.

### Renal and Genitourinary System
-   **Renal Function:** GFR declines with age. Drug clearance is reduced, necessitating dose adjustments.
-   **Bladder:** Capacity decreases, and residual volume increases. Involuntary bladder contractions become more common.
-   **Men:** Benign Prostatic Hyperplasia (BPH) is very common, causing obstruction.
-   **Women:** Atrophic vaginitis (due to estrogen loss) causes dryness, dyspareunia, and increased urinary tract infection risk.

:::correlate
Urinary Incontinence

- **Pathophysiology:** Multifactorial—bladder modification (detrusor instability), pelvic floor weakness, BPH (men), or functional inability to reach the toilet.
- **Presentation:** Involuntary leakage (Stress, Urge, Overflow, or Functional).
- **Lecturer's Point:** Incontinence is **NOT** a normal part of aging; it is a common but pathologic condition that should be treated to prevent social isolation.
:::

### Nervous System
-   **Sensory:** Decreased vibratory sense and proprioception (increasing fall risk).
-   **Reflexes:** Deep tendon reflexes may be diminished, especially at the ankles.
-   **Thermoregulation:** Susceptibility to hypothermia increases. Fever response to infection is blunted.

:::correlate
Presbycusis

- **Pathophysiology:** Sensorineural hearing loss due to loss of hair cells in the cochlea.
- **Presentation:** Bilateral, symmetric, high-frequency hearing loss. Difficulty hearing speech in noisy environments.
- **Social Impact:** Can lead to depression and social withdrawal if untreated.
:::

## Approach to the Geriatric Patient (Slide 13-17)

### The Office Environment
The physical setting should be adapted to minimize barriers.
-   **Lighting:** Bright, glare-free lighting accommodates presbyopia and cataracts.
-   **Access:** Remove clutter (fall hazards). Use chairs with arms to assist in standing.
-   **Temperature:** Keep rooms warm, as elderly patients are sensitive to cold.

### Communication Strategies
-   **Pace:** Slow down. Allow time for the patient to process questions and respond.
-   **Sensory Aids:** Ensure the patient is wearing their glasses and hearing aids.
-   **Position:** Sit at eye level, facing the patient directly to allow for lip-reading.
-   **Health Literacy:** Use large font for printed instructions. Avoid medical jargon.

## Functional Assessment (Slide 18-20)

Functional status is the "vital sign" of geriatrics. It is a stronger predictor of mortality and quality of life than specific disease diagnoses.

### Activities of Daily Living (ADLs)
These are basic self-care tasks required for survival. **DEATH** is a common mnemonic (Dressing, Eating, Ambulating/Transfer, Toileting, Hygiene/Bathing).
*   **Transcript items:** Bathing, Dressing, Toileting, Transferring, Continence, Feeding.

### Instrumental Activities of Daily Living (IADLs)
These are more complex skills needed for independent living in the community. **SHAFT** is a mnemonic (Shopping, Housekeeping, Accounting, Food prep, Telephone).
*   **Transcript items:** Telephone, Shopping, Food preparation, Housekeeping, Laundry, Transportation, Medications, Finances.
*   **Significance:** IADL impairment often precedes ADL impairment and is an early sign of cognitive decline (e.g., trouble managing finances).

:::highyield
**The "10-Minute Screener"**
A rapid, validated tool to assess key geriatric domains:
1.  **Vision:** Ask about difficulty; objective test (Snellen).
2.  **Hearing:** Whisper test or audiometry.
3.  **Mobility:** Timed Up and Go (TUG) test.
4.  **Urinary Incontinence:** "In the last year, have you lost your urine and gotten wet?"
5.  **Nutrition:** Weight loss >10lbs in 6 months?
6.  **Memory:** Three-item recall.
7.  **Depression:** "Do you often feel sad or depressed?"
:::

## Medication Management (Slide 21-22)

### The Beers Criteria
A list of "Potentially Inappropriate Medications" (PIMs) in older adults, published by the American Geriatrics Society (AGS).
-   **Goal:** Reduce adverse drug events (falls, delirium, GI bleeds).
-   **Common Culprits:** Benzodiazepines (falls/confusion), Anticholinergics (confusion/constipation), NSAIDs (GI bleed/renal injury), PPIs (C. diff/osteoporosis).
-   **Nuance:** It is a guideline, not a law. Sometimes a medication is necessary despite being on the list, but it requires careful documentation and monitoring.

### Polypharmacy
Defined as using multiple drugs (typically >5).
-   **Adverse Risk:** Increases exponentially with the number of drugs.
-   **Review:** "Brown Bag" review (bring all pill bottles to every visit) is the gold standard for reconciliation.

## Cognitive Screening (Slide 23-26)

Cognitive decline is common but often goes unreported. Early detection allows for planning and safety interventions.

| Test | Description | Pros | Cons |
| :--- | :--- | :--- | :--- |
| **MMSE** (Folstein) | 30-point scale. Tests orientation, registration, attention, recall, language. | Widely known. Score <24 suggests impairment. | Copyrighted. Education/Language bias. Less sensitive for Mild Cognitive Impairment (MCI). |
| **MoCA** (Montreal) | 30-point scale. Tests executive function, visuospatial, naming, memory. | **Excellent sensitivity for Mild Cognitive Impairment.** | Takes longer (~10-15 min). Requires training. |
| **Mini-Cog** | 1. Three-word registration<br>2. Clock Drawing Test<br>3. Three-word recall | Very fast (<3 min). High sensitivity for dementia. | Less detailed than MoCA. |

:::correlate
Dementia vs. Delirium

- **Dementia:** Chronic, progressive decline in cognition (months to years). Attention is usually intact until late stages.
- **Delirium:** **Acute** onset (hours to days), fluctuating course, **inattention** (hallmark). Usually reversible if underlying cause (UTI, meds, electrolyte imbalance) is treated.
- **Lecturer's Point:** The Mini-Cog is a great quick screen for baseline deficits, but always assess for acute changes (delirium) first.
:::

## Fall Risk and Mobility (Slide 27)

Falls are the leading cause of fatal and non-fatal injuries in older adults.
-   **Risk Factors:** Polypharmacy (>4 meds), environmental hazards (rugs, poor lighting), lower extremity weakness, sensory impairment.
-   **Assessment Tool:** **Timed Up and Go (TUG)**.
    -   Patient starts sitting, stands, walks 3 meters (10 ft), turns, walks back, and sits.
    -   **Normal:** < 10 seconds.
    -   **Abnormal (High Risk):** > 20 seconds (Transcript references >20s as abnormal/cutoff for high risk).

## Health Maintenance and Screening (Slide 28-35)

Decisions for screening should be individualized based on life expectancy (>10 years rule) and functional status, rather than chronological age alone.

### Cancer Screening
-   **Breast:** Mammography every 1-2 years until age 75. Discuss pros/cons after 75.
-   **Colorectal:** Colonoscopy/FIT testing until age 75. Decision 76-85 is individual. Stop >85.
-   **Prostate:** PSA screening is controversial; shared decision making based on risk/benefit.
-   **Lung:** Low-dose CT for high-risk smokers (50-80 yo, 20 pak-year history, current or quit <15y ago).

### Immunizations
-   **Influenza:** Annual (High-dose preferred for >65).
-   **Pneumococcal:** PCV15/20 followed by PPSV23 (if 15 used).
-   **Zoster (Shingles):** Shingrix (2 doses). Recommended for all >50.
-   **Tdap:** Tetanus booster every 10 years.
-   **COVID-19:** Follow current CDC guidelines.

### Osteoporosis Screening
-   **Tool:** **DEXA Scan** (Dual-Energy X-ray Absorptiometry).
-   **Indication:**
    -   All Women **≥ 65 years**.
    -   Men **≥ 70 years**.
    -   Younger postmenopausal women or men 50-69 with risk factors (fragility fracture, steroids, RA, smoking, alcohol).
-   **Diagnosis (T-Score):**
    -   **Normal:** ≥ -1.0
    -   **Osteopenia:** -1.0 to -2.5
    -   **Osteoporosis:** ≤ -2.5 (Treatment indicated)
-   **FRAX Score:** Calculates 10-year fracture risk. Use to decide treatment in patients with Osteopenia (Treat if Hip Fracture risk ≥3% or Major Osteoporotic Fracture risk ≥20%).

:::highyield
**Elder Abuse & Neglect**
- **Types:** Physical, Sexual, Emotional, Financial, Neglect (including Self-Neglect).
- **Perpetrators:** 90% are family members.
- **Screening:** No single tool, but ask direct questions: "Do you feel safe at home?", "Is anyone hurting you?"
- **Action:** Mandatory reporting to **Adult Protective Services (APS)** if there is *suspicion*. You do not need proof.
:::`,
        questions: [
            {
...
#### Physiology of Aging
- **Cardiovascular**: Arterial stiffness -> Increased SBP, S4 heart sound
- **Respiratory**: Decreased compliance, blunted cough reflex (Pneumonia risk)
- **Renal**: Decreased GFR, decreased drug clearance
- **Sensory**: Presbycusis (High freq loss), Presbyopia, Cataracts

#### Functional Assessment
- **ADLs (DEATH)**: Dressing, Eating, Ambulating, Toileting, Hygiene
- **IADLs (SHAFT)**: Shopping, Housekeeping, Accounting, Food prep, Telephone
- **Fall Risk**: TUG Test (>12s abnormal)

#### Screening & Prevention
- **Cognition**: MMSE, Mini-Cog, MoCA (Best for MCI)
...
- **Meds**: Beers Criteria (Avoid Anticholinergics, Benzos)`
    },
    {
        ...
        transcript: '',
        summary: `# Lecture #60: Sacral MET (Part 2)

**Lecturer:** Deb Whitson, D.O.
**Session:** Lecture #60

## Introduction and Objectives
This lecture serves as a preparation for the OMM Lab on Sacral Muscle Energy Treatment (MET), specifically focusing on **Unilateral** and **Bilateral** sacral dysfunctions. It builds upon previous sacral mechanics concepts.

The core goal is to differentiate between **Physiologic** (Flexion) and **Non-Physiologic** (Extension) dysfunctions using static landmarks (Sulci, ILAs) and dynamic testing (Spring, Sphinx).

---

## Sacral Diagnosis Review (Slide 2-3)

### Physiologic Motion (Nutated)
*   **Sacral Flexion:** The sacral base moves anteriorly.
*   **Respiratory:** Occurs during **Inhalation**.
*   **Associated Dysfunctions:** Unilateral Flexion, Bilateral Flexion, Forward Torsions.

### Non-Physiologic Motion (Counternutated)
*   **Sacral Extension:** The sacral base moves posteriorly.
*   **Respiratory:** Occurs during **Exhalation**.
*   **Associated Dysfunctions:** Unilateral Extension, Bilateral Extension, Backward Torsions.

---

## Unilateral Sacral Dysfunctions (Slide 4-6)

These dysfunctions occur when one side of the sacrum moves more than the other, but without a defined oblique axis like torsions. They are often termed **Shears**.

### 1. Unilateral Sacral Flexion (Inferior Shear)
*   **Mechanism:** One side of the sacral base moves anteriorly and gets stuck deep.
*   **Findings (e.g., Left Unilateral Flexion):**
    *   **Seated Flexion Test:** Positive on the **Dysfunctional Side** (Left).
    *   **Sacral Sulcus:** **Deep** on the dysfunctional side (Left).
    *   **ILA:** **Posterior/Inferior** on the dysfunctional side (Left).
    *   **L5:** Rotated **Toward** the dysfunctional side (Deep sulcus attracts L5).
*   **Provocation Tests:**
    *   **Spring Test:** **Negative** (Good spring / "Good Dog").
    *   **Sphinx Test:** **Negative** (Symmetry improves or stays same).

### 2. Unilateral Sacral Extension (Superior Shear)
*   **Mechanism:** One side of the sacral base moves posteriorly and gets stuck shallow.
*   **Findings (e.g., Left Unilateral Extension):**
    *   **Seated Flexion Test:** Positive on the **Dysfunctional Side** (Left).
    *   **Sacral Sulcus:** **Shallow** on the dysfunctional side (Left).
    *   **ILA:** **Anterior/Superior** on the dysfunctional side (Left).
    *   **L5:** Rotated **Away** from the dysfunctional side (Shallow sulcus pushes L5 away).
*   **Provocation Tests:**
    *   **Spring Test:** **Positive** (Resistance / "Bad Dog").
    *   **Sphinx Test:** **Positive** (Asymmetry worsens).

:::pearl
**Shear Rule:**
In a Unilateral Dysfunction (Shear), the **Deep Sulcus** and **Posterior ILA** are on the **SAME SIDE**.
*(Contrast with Torsions, where they are on OPPOSITE sides).*
:::

---

## Bilateral Sacral Dysfunctions (Slide 8-11)

These involve the entire sacral base moving together (Symmetric).

### 1. Bilateral Sacral Flexion
*   **Mechanism:** Both sacral bases move anteriorly (Nutated) and get stuck. common in post-partum or after heavy lifting.
*   **Findings:**
    *   **Seated Flexion Test:** False Negative (Symmetric).
    *   **Sacral Sulci:** **Deep** Bilaterally.
    *   **ILAs:** **Posterior/Inferior** Bilaterally.
*   **Provocation Tests:**
    *   **Spring Test:** **Negative**.
    *   **Sphinx Test:** **Negative**.

### 2. Bilateral Sacral Extension
*   **Mechanism:** Both sacral bases move posteriorly (Counternutated). "Extension = Exhalation = Excavation" (shallow).
*   **Findings:**
    *   **Seated Flexion Test:** False Negative (Symmetric).
    *   **Sacral Sulci:** **Shallow** Bilaterally.
    *   **ILAs:** **Anterior/Superior** Bilaterally.
*   **Provocation Tests:**
...
## Summary of Diagnosis (Slide 13)

| Dysfunction | Sulcus | ILA | Spring Test |
| :--- | :--- | :--- | :--- |
| **Unilateral Flexion** | Deep (Same side) | Posterior (Same side) | Negative (-) |
| **Unilateral Extension** | Shallow (Same side) | Anterior (Same side) | Positive (+) |
| **Bilateral Flexion** | Deep (Bilateral) | Posterior (Bilateral) | Negative (-) |
| **Bilateral Extension** | Shallow (Bilateral) | Anterior (Bilateral) | Positive (+) |

:::highyield
**Spring & Sphinx Rules**
*   **Spring Test:** Tests for **Extension** (Resistance).
    *   Positive = Stuck in Extension ("Bad Dog" - bites/hard).
    *   Negative = Flexion allowed ("Good Dog" - soft/springy).
*   **Sphinx Test:** Tests for **Flexion** (Ability to move forward).
    *   Positive (Worsens) = Cannot flex (Stuck in Extension).
    *   Negative (Improves) = Can flex (Stuck in Flexion or Normal).
:::

:::correlate
**L5 Rules (Fryette's)**
*   **Rotation:** L5 rotates **Opposite** to the Sacrum.
    *   Sacrum facing Left -> L5 rotates Right.
*   **Sidebending:** L5 sidebends **Same side** as the Oblique Axis (for torsions).
    *   For shears (Unilateral), L5 simply follows the distinct "Deep Sulcus attracts, Shallow Repels" rule.
:::`,
        questions: [
            {
...
#### Unilateral (Shears)
*   **Unilateral Flexion (Inferior)**
    *   **Sulcus**: Deep (Same side)
    *   **ILA**: Posterior (Same side)
    *   **Tests**: Spring (-), Sphinx (-)
*   **Unilateral Extension (Superior)**
    *   **Sulcus**: Shallow (Same side)
    *   **ILA**: Anterior (Same side)
    *   **Tests**: Spring (+), Sphinx (+)

#### Bilateral (Symmetric)
*   **Bilateral Flexion**
    *   **Sulci**: Deep Bilaterally
    *   **ILAs**: Posterior Bilaterally
    *   **Tests**: Spring (-)
*   **Bilateral Extension**
